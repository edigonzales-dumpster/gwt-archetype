...
import ${package}.shared.SettingsServiceAsync;
...
public class AppEntryPoint implements EntryPoint {
    ...
    private NumberFormat fmtPercent = NumberFormat.getFormat("${symbol_pound}0.0");
   ...
   private static native void updateURLWithoutReloading(String newUrl) /*-{
        ${symbol_dollar}wnd.history.pushState(newUrl, "", newUrl);
    }-*/;
}